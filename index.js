...
const fetchWeather = async (city) => {
    try {
        const response = await fetch(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=${city}&APPID=d396e732e26fc8250e814ba390886903`, {mode: 'cors'})
...
const updateDOM = (information) => {
    ...
    img.src = `https://cors-anywhere.herokuapp.com/http://openweathermap.org/img/wn/${information.image}@2x.png`;
}
